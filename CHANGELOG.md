...
* **process_new_files:** make Archive move idempotent ([da7a33d](https://github.com/mini-app-polis/deejay-cog/commit/da7a33d193496956bbad80db858d26e456ddc6d0))
...
* follow up to evaluation cog changes ([6f9884d](https://github.com/mini-app-polis/deejay-cog/commit/6f9884d400f12e017b581f832a828fb30e48e52d))
...
* upgrade common for auth ([65346a9](https://github.com/mini-app-polis/deejay-cog/commit/65346a9ce7266a3d7df46247a17ea23cebed3196))
...
* closing requirements gap, fixing release ([7a59a79](https://github.com/mini-app-polis/deejay-cog/commit/7a59a7998c30b257bb4a5ed9d695649b3617e96a))
...
* build ([2e0e5b5](https://github.com/mini-app-polis/deejay-cog/commit/2e0e5b537e063c3789acab1f1068fa2520f96080))
...
* deployment prefect fix ([074a28e](https://github.com/mini-app-polis/deejay-cog/commit/074a28e0d5accc22810a8de0c5fcc7fd073383de))
* deployment prefect fix ([71e727c](https://github.com/mini-app-polis/deejay-cog/commit/71e727c758b341013f986dd9a0608bcd8901d88b))

## [1.11.1](https://github.com/mini-app-polis/deejay-cog/compare/v1.11.0...v1.11.1) (2026-03-29)


### Bug Fixes

* deployment prefect fix ([45fc605](https://github.com/mini-app-polis/deejay-cog/commit/45fc605b611b2816bb5b00692de96e1e92947aec))
...
* fix ([621b0ec](https://github.com/mini-app-polis/deejay-cog/commit/621b0ec7e540b54650aa98e0859c5d70d38354b1))

## [1.10.13](https://github.com/mini-app-polis/deejay-cog/compare/v1.10.12...v1.10.13) (2026-03-28)


### Bug Fixes

* fix ([77a88f0](https://github.com/mini-app-polis/deejay-cog/commit/77a88f038066db17f7a83c8f3ff7f121618ea948))

## [1.10.12](https://github.com/mini-app-polis/deejay-cog/compare/v1.10.11...v1.10.12) (2026-03-28)


### Bug Fixes

* fix ([693f22a](https://github.com/mini-app-polis/deejay-cog/commit/693f22adb7fb034b859f122a7a43999bdb64c8f1))

## [1.10.11](https://github.com/mini-app-polis/deejay-cog/compare/v1.10.10...v1.10.11) (2026-03-28)


### Bug Fixes

* fix ([61d1814](https://github.com/mini-app-polis/deejay-cog/commit/61d181497f5b87380bf4cae0077d2def7b52a193))

## [1.10.10](https://github.com/mini-app-polis/deejay-cog/compare/v1.10.9...v1.10.10) (2026-03-28)


### Bug Fixes

* fix ([04484ff](https://github.com/mini-app-polis/deejay-cog/commit/04484ffd0f6af1bd5f11d269219e5d3a4a5e5bd8))

## [1.10.9](https://github.com/mini-app-polis/deejay-cog/compare/v1.10.8...v1.10.9) (2026-03-28)


### Bug Fixes

* fix ([4a8bb01](https://github.com/mini-app-polis/deejay-cog/commit/4a8bb0116f7cc24ad438c58ac2e7a7d1f774dca2))

## [1.10.8](https://github.com/mini-app-polis/deejay-cog/compare/v1.10.7...v1.10.8) (2026-03-28)


### Bug Fixes

* fix ([2c06818](https://github.com/mini-app-polis/deejay-cog/commit/2c068189bf9398019d832603f60921134eddff80))

## [1.10.7](https://github.com/mini-app-polis/deejay-cog/compare/v1.10.6...v1.10.7) (2026-03-28)


### Bug Fixes

* build ([e84991f](https://github.com/mini-app-polis/deejay-cog/commit/e84991f91d430681d90e0a00c39fa0ed40afab1a))

## [1.10.6](https://github.com/mini-app-polis/deejay-cog/compare/v1.10.5...v1.10.6) (2026-03-28)


### Bug Fixes

* getting build ([75a6932](https://github.com/mini-app-polis/deejay-cog/commit/75a6932762ab2a7fe80b88f851939ac1db7f8904))

## [1.10.5](https://github.com/mini-app-polis/deejay-cog/compare/v1.10.4...v1.10.5) (2026-03-28)


### Bug Fixes

* fix ([3455635](https://github.com/mini-app-polis/deejay-cog/commit/345563501fcc5863b9978890d886a4f44775d87a))

## [1.10.4](https://github.com/mini-app-polis/deejay-cog/compare/v1.10.3...v1.10.4) (2026-03-28)


### Bug Fixes

* build ([8a25a10](https://github.com/mini-app-polis/deejay-cog/commit/8a25a104ad2c7419330669b29fbadb2647f2198e))
...
* updating with use findings ([e4eed55](https://github.com/mini-app-polis/deejay-cog/commit/e4eed5549b6e2f14bd44c2ab4b2e10f96ff05822))
...
* finalizing process ([62c9b16](https://github.com/kaianolevine/deejay-cog/commit/62c9b168473872cbe4d3a6bd6f02ad3e1b5f0f57))
...
- Fixed false ERROR finding when no new sets were available to ingest. No-op ingest is now correctly treated as success.

## [0.0.77] - 2026-03-19

### Changed

- Improved Claude prompt for pipeline evaluation to enforce raw JSON output. Added system prompt for better instruction following.
